...
**Live:** [younus-create.vercel.app](https://younus-create.vercel.app) &nbsp;|&nbsp; **GitHub:** [YounusMahr/cinematic-portfolio](https://github.com/YounusMahr/cinematic-portfolio)
...
```bash
git clone https://github.com/YounusMahr/cinematic-portfolio.git
...
| `location`       | Country and availability (e.g. Pakistan, Worldwide) |
...
**Muhammad Younus** — Full Stack Engineer & AI Builder

[GitHub](https://github.com/YounusMahr) &nbsp;|&nbsp; [LinkedIn](https://www.linkedin.com/in/younus-web-developer/) &nbsp;|&nbsp; [Medium](https://medium.com/@muhammadyounus) &nbsp;|&nbsp; [Instagram](https://www.instagram.com/younus.create) &nbsp;|&nbsp; [YouTube](https://www.youtube.com/@younus.create)
